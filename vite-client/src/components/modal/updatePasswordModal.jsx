            ...
            {!passwordChanged ? (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded-3xl w-[80%] relative">
                        ...
                        <div className="mt-2">
                            <label className="inline-block mb-1" for="newPassword">Neues Passwort</label>
                            <input type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} className="w-full p-1.5 pl-3 rounded-xl bg-gray-100" id="newPassword"/>
                        </div>
                        <div className="mt-2">
                            <label className="inline-block mb-1" for="newPasswordRequired">Passwort wiederholen</label>
                            <input type="password" value={repeatPassword} onChange={(e) => setRepeatPassword(e.target.value)} className="w-full p-1.5 pl-3 rounded-xl bg-gray-100" id="newPasswordRequired"/>
                        </div>
