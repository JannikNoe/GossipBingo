            ...
            {!emailChanged ? (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded-3xl w-[80%] relative">
                        ...
                        <div className="mt-2">
                            <label className="inline-block mb-1">Neue E-Mail-Adresse</label>
                            <input type="email" value={newEmail} onChange={(e) => setNewEmail(e.target.value)} className="w-full p-1.5 pl-3 rounded-xl bg-gray-100"/>
                        </div>
                        <div className="mt-2">
                            <label className="inline-block mb-1">E-Mail-Adresse wiederholen</label>
                            <input type="email" value={repeatEmail} onChange={(e) => setRepeatEmail(e.target.value)} className="w-full p-1.5 pl-3 rounded-xl bg-gray-100"/>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white p-6 rounded-3xl w-[80%] relative">
                        ...
                        <button onClick={onClose} className="uppercase w-full rounded-2xl bg-bgDarkGrayPrimary px-3 py-3 text-md font-semibold text-white shadow-sm mt-4">
                            Schließen
                        </button>
                    </div>
                </div>
